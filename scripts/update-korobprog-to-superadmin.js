...
async function updateKorobprogToSuperAdmin() {
  const targetUserId = 'cmb9k4mtb0000mkc4b5uwfgtz';
  const targetEmail = 'korobprog@gmail.com';
  const newRole = 'superadmin';

  console.log(
    '🔄 Начинаем процесс изменения роли пользователя korobprog@gmail.com...'
  );
  ...
  try {
    ...
    // 6. Дополнительная информация о всех superadmin пользователях
    ...
    console.log('🔄 Необходимо перезайти в систему для применения изменений');
  } catch (error) {

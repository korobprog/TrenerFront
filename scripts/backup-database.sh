...
# Скрипт резервного копирования базы данных TrenerFront
...
echo "   2. Восстановите: docker-compose exec -T postgres psql -U $POSTGRES_USER -d $POSTGRES_DB < ${BACKUP_FILE}"
echo ""